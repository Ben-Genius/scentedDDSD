    ...
    if (!collectionData) {
        return (
            <div className="min-h-[60vh] flex flex-col items-center justify-center">
                ...
                <Link to="/shop" className="text-sm underline uppercase tracking-widest">Return to Shop</Link>
            </div>
        );
    }

    return (
        <div className="bg-[#fffcf8] min-h-screen pb-12 pt-16 md:pt-14"> {/* pt added to clear fixed header */}
            <div className=" mx-auto px-6 md:px-12 max-w-[110rem]">
                ...
                <div className="text-center max-w-3xl mx-auto mb-20 space-y-6">
                    ...
                    <p className="font-inter text-sm md:text-base text-black/70 leading-relaxed font-light max-w-xl mx-auto">
                        Discover the essence of our {collectionData.title}. A curated selection of our finest fragrances,
                        designed to transform your space into a sanctuary of elegance and warmth.
                    </p>
                </div>
                ...
                {collectionProducts.length > 0 ? (
                    ...
                    <div className="text-center py-20 bg-white/50 border border-black/5">
                        <p className="text-black/40 font-playfair italic">No products found in this collection.</p>
