...
const Hero = () => {
    ...
    return (
        <div ref={containerRef} className="relative w-full h-[77vh] bg-rose-gold overflow-hidden">
            ...
            {/* Content Overlay */}
            <div ref={textRef} className="absolute bottom-6 left-2 md:bottom-6 md:left-3 max-w-sm bg-black/0 backdrop-blur-sm border border-white/10 p-8 md:p-10 rounded-2xl text-white shadow-2xl">
